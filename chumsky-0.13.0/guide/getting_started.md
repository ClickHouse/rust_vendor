...
[open a bug report](https://codeberg.org/zesterer/chumsky/issues/new).
...
writing parsers. The main repository has [plenty of examples](https://codeberg.org/zesterer/chumsky/src/branch/main/examples)
