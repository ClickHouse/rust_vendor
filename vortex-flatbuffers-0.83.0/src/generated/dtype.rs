...
pub fn root_as_dtype(buf: &[u8]) -> Result<DType<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_dtype(buf: &[u8]) -> Result<DType<'_>, ::flatbuffers::InvalidFlatbuffer> {
