use crate::v110::{cityhash_110_128, cityhash_110_128_with_seed};
use std::vec::Vec;
...
fn test_standard_iter(expected: &[u64; 16], input: &[u8]) {
    println!("running test of length {}", input.len());
    let u = cityhash_110_128(input);
    let v = cityhash_110_128_with_seed(input, (1234567u64, K0));
